...
CREATE DATABASE Scheduler;
 ...
 CONSTRAINT uk_userLogin unique (uemail)
 );
 ...
 CONSTRAINT uk_userInfo unique (uemail),
 ...
 CONSTRAINT uk_compnayInfo unique (cname)
 );
 ...
 friOpen	time,
 friClose	time,
 CONSTRAINT pk_availabiltiy primary key (uemail),
